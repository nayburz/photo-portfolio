...
export default function Home() {
  return (
    <div className="flex flex-col h-full bg-[url('/photo_background.jpg')] bg-top bg-cover">
      <Head>
      ...
      <main className="grow">
        <div className="flex flex-col items-center h-full">
          <Tab.Group>
            ...
            <Tab.Panels className="bg-stone-700 bg-opacity-80 h-full max-w-[900px] w-full p-2 sm:p-4 my-6">
